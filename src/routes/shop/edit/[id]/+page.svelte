...
>
	...
	>
		...
		<form method="post" use:enhance action="?/edit" class="space-y-6">
			<div>
				<label class="mb-1 block font-semibold text-gray-700" for="name">Nom</label>
				<input
					id="name"
					name="name"
					required
			...
			<div>
				...
				<textarea
					...
					placeholder="Décrivez l'article">{item.description}</textarea
				>
			</div>
			<div>
				<label class="mb-1 block font-semibold text-gray-700" for="price">Prix (points)</label>
				<input
					id="price"
					name="price"
					type="number"
		...
		<div class="mt-6 text-center">
			<a href="/shop" class="font-medium text-indigo-600 transition hover:text-fuchsia-600"
