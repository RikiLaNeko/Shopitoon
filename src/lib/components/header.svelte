...
<header
	class="relative sticky top-0 z-50 bg-white/75 shadow-md backdrop-blur-md transition-all duration-300"
>
	<!-- Effet de dégradé sur le bord inférieur -->
	<div
		class="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-blue-600 via-fuchsia-500 to-indigo-600 opacity-60"
	></div>
